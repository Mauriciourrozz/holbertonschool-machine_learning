...
class NeuralNetwork:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05):
        """
            Trains the neural network by running forward propagation,
        computing gradients, and updating weights over a number of iterations.

        Args:
        X (np.ndarray): Input data of shape (nx, m), where nx is the number
                        of features and m is the number of examples.
        Y (np.ndarray): True labels of shape (1, m), with values 0 or 1.
        iterations (int): Number of training iterations.
        Must be a positive integer.
        alpha (float): Learning rate. Must be a positive float.
        """
