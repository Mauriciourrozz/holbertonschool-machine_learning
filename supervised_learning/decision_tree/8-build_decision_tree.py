...
class Decision_Tree():
    ...
    def possible_thresholds(self, node, feature):
        """
        Function that computes the possible thresholds
        """
    ...
    def Gini_split_criterion_one_feature(self, node, feature):
        """
        Function that computes the Gini index for a given feature
        and returns the best threshold and the Gini index
        """
        ...
        X_exp = Xf[:, None, None]
        thr_exp = thresholds[None, :, None]
        cls_exp = classes[None, None, :]
        y_exp = y[:,    None, None]

        Left_bool = (X_exp > thr_exp) & (y_exp == cls_exp)
        Right_bool = (X_exp <= thr_exp) & (y_exp == cls_exp)
    ...
    def Gini_split_criterion(self, node):
        """
        Function that computes the Gini index for all features
        """
