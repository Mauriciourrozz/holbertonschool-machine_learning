...
def variance(X, C):
    ...
    try:
        ...
        # Calculo la distancia al cuadrado en cada dimensión
        # Sumo por dimensión para obtener matriz de distancias al cuadrado
        ...
        # Para eso, uso dist_sq y clss para seleccionar solo
        # la distancia del cluster asignado
